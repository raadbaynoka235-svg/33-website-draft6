          ...
          {currentStep === 1 && (
            <div className="space-y-4">
              <input
                ...
                required
                className="w-full bg-gray-100 text-gray-900 placeholder-gray-600 rounded-400g px-6 py-4 text-base focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all"
              />
              <input
                type="text"
                name="lastName"
